...
<body>
<div align="center"><img src="Images/Cari Data Laptop.png" width="720" height="109" />
   
    <form action="Config_cari.php"method="post" target="Utama">
    	Nama tipe laptop: <input type="text" name="nama">
