...
<body>
<form action="Proses_edit.php" method="post" name="form1" target="Utama" id="form1">
  <h2 align="center"><img src="Images/Edit Laptop.png" width="720" height="109" /></h2>
  <p>
    <label for="nama">
    <div align="center"></div>
    </label>
    <div align="center">Nama Tipe Laptop
